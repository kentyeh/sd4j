...
@NamedNativeQueries({
    ...
    @NamedNativeQuery(name = "Member.findMappingAll", query = "select id as id_L,name as name_S,userType as userType_E from member", resultSetMapping = "memberMapping"),
...
//    @OrderColumn(name = "phone")
     ...
     * @param userType 
     */
    public Member(Long id, String name,String userType) {
        this.id = id;
        this.name = name;
